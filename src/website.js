 ...
 */
   ...
   */
    ...
    retrieveToFile(propertyLookup, toFile, versionLookup = LATEST_VERSION.LATEST, hosts=false) {
        return this.retrieve(propertyLookup, versionLookup, hosts)
            .then(data => {
    ...
    retrievePropertyDetails(propertyLookup, toFile, versionLookup = LATEST_VERSION.LATEST) {
